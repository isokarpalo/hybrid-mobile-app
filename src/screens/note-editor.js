...
export const NoteEditor = (props) => {
    ...
    React.useEffect(() => {
        ...
        if (props.route.params.filename && typeof props.route.params.filename === 'string') { //tällä rivillä virhe, render error, undefined is not an object (evaluating 'props.route.params.filename')
            // readNote
